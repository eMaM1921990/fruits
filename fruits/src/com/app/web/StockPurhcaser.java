...
/**
 * Servlet implementation class StockPurhcaser
 */
@WebServlet("/StockPurhcaser")
public class StockPurhcaser extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StockPurhcaser() {
        super();
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String defaultURL="/purchase/stock_purchaser.jsp";
		...
		try {
			request.setAttribute("purchaser", bp_business.purchaser(request));
