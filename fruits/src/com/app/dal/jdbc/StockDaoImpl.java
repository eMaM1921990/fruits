...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT id, stock_name FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( id, stock_name ) VALUES ( ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET id = ?, stock_name = ? WHERE id = ?";
	...
	/** 
	 * Index of column stock_name
	 */
	protected static final int COLUMN_STOCK_NAME = 2;
	...
	public StockPk insert(Stock dto) throws StockDaoException
	{
		...
		try {
			...
			stmt.setString( index++, dto.getStockName() );
			...
			_e.printStackTrace();
			throw new StockDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	{
		Stock ret[] = findByDynamicSelect( SQL_SELECT + " WHERE id = ?", new Object[] {  new Integer(id) } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE stock_name = ? ORDER BY stock_name", new Object[] { stockName } );
	}
	 ...
	 * @param userConn
	 */
	public StockDaoImpl(final java.sql.Connection userConn)
	{
	 ...
	 */
	protected Stock fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			Stock dto = new Stock();
			populateDto( dto, rs);
	 ...
	 */
	protected Stock[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Stock ret[] = new Stock[ resultList.size() ];
	 ...
	 */
	protected void populateDto(Stock dto, ResultSet rs) throws SQLException
	{
		dto.setId( rs.getInt( COLUMN_ID ) );
		dto.setStockName( rs.getString( COLUMN_STOCK_NAME ) );
	}

	/** 
	 * Resets the modified attributes in the DTO
	 */
	protected void reset(Stock dto)
	{
	}
