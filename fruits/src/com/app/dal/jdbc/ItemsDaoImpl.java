...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT id, name, quantity, stock_id, code, price FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( id, name, quantity, stock_id, code, price ) VALUES ( ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET id = ?, name = ?, quantity = ?, stock_id = ?, code = ?, price = ? WHERE id = ?";
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE stock_id = ?", new Object[] {  new Integer(stockId) } );
	}
