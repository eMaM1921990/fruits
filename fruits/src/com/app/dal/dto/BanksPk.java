...
/** 
 * This class represents the primary key of the banks table.
 */
public class BanksPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BanksPk)) {
			return false;
		}
		
		final BanksPk _cast = (BanksPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.dal.dto.BanksPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
