...
/** 
 * This class represents the primary key of the patti table.
 */
public class PattiPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof PattiPk)) {
			return false;
		}
		
		final PattiPk _cast = (PattiPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.dal.dto.PattiPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
