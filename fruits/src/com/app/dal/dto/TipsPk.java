...
/** 
 * This class represents the primary key of the tips table.
 */
public class TipsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TipsPk)) {
			return false;
		}
		
		final TipsPk _cast = (TipsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.dal.dto.TipsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
