...
/** 
 * This class represents the primary key of the loans table.
 */
public class LoansPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof LoansPk)) {
			return false;
		}
		
		final LoansPk _cast = (LoansPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.dal.dto.LoansPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
