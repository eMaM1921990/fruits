...
/** 
 * This class represents the primary key of the tray table.
 */
public class TrayPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TrayPk)) {
			return false;
		}
		
		final TrayPk _cast = (TrayPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.dal.dto.TrayPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
