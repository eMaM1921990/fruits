...
/** 
 * This class represents the primary key of the invoice_line table.
 */
public class InvoiceLinePk implements Serializable
{
	 ...
	 * @param id
	 */
	public InvoiceLinePk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof InvoiceLinePk)) {
			return false;
		}
		
		final InvoiceLinePk _cast = (InvoiceLinePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.dal.dto.InvoiceLinePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
