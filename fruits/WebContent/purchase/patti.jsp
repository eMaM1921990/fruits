	                            		...
	                            		<tr id="1">
	                            			<td>
	                            				<div class="select-style">
		                            				...
		                            				<select name="itemId" onchange="getItemActualCost(this.value,1);getAvg(this.value,1);balance(1)" id="itemId">
	                            			...
	                            			<td><input type="hidden" id="purchaser_1"><input type="text" name="avgCost" id="avgCost_1" style="width: 50px"/></td>
...
function addNewRow(){
	lastID=lastID+1;
	var fruit="<div class='select-style'><select name='itemId' onchange='getItemActualCost(this.value,"+lastID+");getAvg(this.value,"+lastID+");balance("+lastID+")' id='itemId'><option>Select Fruit</option>";
	for (var key in dict) {
