                    ...
                    <div id="content">
                   	<%@include file="../notification.jsp" %>
                    	...
                    	<table>
                    		...
                    		<tr>
                    			<td colspan="1"><input type="button" class="button-style" value="Get Tray" onclick="getTray()"/></td>
                    		</tr>
                    	</table>
...
function addNewRow(Json){
	...
	for(var i=0;i<Json.length;i++){
		lastID=lastID+1;
		var date=Json[i].createdAt;
		var bpName=Json[i].bpName;
		var name=Json[i].name;
		var numberOfTray=Json[i].numberOfTray;
		$('#itemstbl > tbody:last-child').append('<tr ><td>'+date+'</td><td>'+bpName+'</td><td>'+name+'</td><td>'+numberOfTray+'</td></tr>');
}
}
